...
void createSuffixArray(string str,int *suffixArray){
	int *givenString= new int[str.length()+1];
	int i;
	...
	// }
	// cout<<"\n";
	createSuffixArrayRecur(givenString,suffixArray,str.length()+1,ALPHABET_SIZE+1);
